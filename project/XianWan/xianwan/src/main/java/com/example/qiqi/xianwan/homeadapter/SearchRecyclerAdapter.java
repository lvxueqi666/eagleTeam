...
public class SearchRecyclerAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public SearchRecyclerAdapter(Context context, List<String> commoId, List<String> images, List<String> introductions, List<String> price, List<String> icon, List<String> userName, List<String> userAccount, List<String> attribute, List<String> showLikes, boolean hasMore){

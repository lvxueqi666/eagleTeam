...
public class BookRecyclerAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public BookRecyclerAdapter(Context context, List<String> commoId, List<String> images, List<String> introductions, List<String> price, List<String> icon, List<String> userName, List<String> userAccount, List<String> attribute, List<String> showLikes, int listStyle, boolean hasMore){
            ...
            if(mListStyle == 0){
                ...
                Glide.with(mContext).asBitmap().load(images.get(position)).diskCacheStrategy(DiskCacheStrategy.ALL).apply(options).into(new BitmapImageViewTarget(((MyRecyclerAdapter.NormalHolder) holder).showIv){
                    ...
                    protected void setResource(Bitmap resource) {
                        ...
                        ((MyRecyclerAdapter.NormalHolder) holder).showIv.setImageDrawable(circularBitmapDrawable);
                    }
                });
